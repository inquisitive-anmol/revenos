        ...
        <div>
            ...
            <div className="max-w-6xl mx-auto p-8">
                ...
                <div className="min-h-[500px]">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    ...
                                    <div className="bg-surface p-6 rounded-2xl shadow-sm border border-outline space-y-4">
                                        ...
                                        <div className="space-y-2 text-xs">
                                            <p className="text-secondary">Working Hours: <span className="text-on-surface font-semibold">09:00 - 18:00</span></p>
                    ...
                    {['profile', 'workspace', 'team', 'email', 'calendar', 'notifications'].includes(activeTab) && (
                        <div className="bg-surface-container-low/50 rounded-2xl p-20 border-2 border-dashed border-outline flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-300">
                             ...
                             <p className="text-secondary font-medium mt-2 max-w-xs">This section is currently under construction as we finalize the precision modules.</p>
                             <button 
