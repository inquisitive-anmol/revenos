...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 h-full bg-surface border-r border-outline flex flex-col shrink-0 z-30 overflow-y-auto">
      {/* Brand Section (from Leads page) */}
      ...
      <div className="p-4 border-t border-outline flex flex-col gap-4">
        ...
        <div className="space-y-2">
          ...
          <Link 
            to="/help" 
            className="flex items-center gap-3 px-4 py-2.5 text-secondary hover:text-on-surface hover:bg-surface rounded-lg transition-all font-semibold text-sm"
          >
