...
export const NotificationPanel: React.FC<NotificationPanelProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 lg:absolute lg:inset-auto lg:right-0 lg:top-full lg:mt-2 lg:w-[380px] lg:h-auto lg:max-h-[600px] z-[100] flex flex-col bg-surface sm:rounded-2xl shadow-2xl overflow-hidden transition-all duration-300">
      
      {/* Mobile Backdrop */}
      <div 
        className="fixed inset-0 bg-on-surface/40 backdrop-blur-sm lg:hidden focus:outline-none" 
        onClick={onClose}
      />

      {/* Main Container */}
      <div className="relative flex-1 flex flex-col bg-surface mt-10 lg:mt-0 lg:rounded-2xl h-full lg:h-auto overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-outline flex items-center justify-between bg-surface-container-low/50">
          <div className="flex items-center gap-3">
            <button 
              onClick={onClose}
              className="lg:hidden p-1 text-secondary hover:text-on-surface transition-colors"
            >
